...
Elite_art = ("""
        ...
        ╚══════╝╚══════╝╚═╝░░░╚═╝░░░╚══════╝  ╚═╝░░╚══╝░╚═════╝░╚═╝░░╚═╝╚══════╝╚═╝░░╚═╝
                               ...
                               *ET ON TOP BABY BAKI SAB LODE PE*
                              ═══════════════════════════════════         
                         ═════════════════════════════════════════════
""")
...
class Elite:
    ...
    def menu(self):
        os.system(f"cls & title Elite Nuker ^| Authenticated as: {__client__.user.name}#{__client__.user.discriminator}")
...
@__client__.event
async def on_ready():
    print("{}({}Elite{}) Authenticated as{}: {}{}".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m", "\x1b[38;5;21m", "\x1b[0m", f"{__client__.user.name}#{__client__.user.discriminator}"))
    time.sleep(1.5)
    Elite().menu()
...
if __name__ == "__main__":
    try:
        ...
        guildid = input("{}({}Elite{}) Guild ID{}:{} ".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m", "\x1b[38;5;21m", "\x1b[0m"))
